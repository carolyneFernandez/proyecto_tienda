...
<input  type="image" src="../imagenes/plantillas/default.png" height="142" width="142">
    ...
    <div class='col-md-2' >
      ...
      <input type="hidden" name="procesar" value="1" />
        <input  type="image"  src="../imagenes/plantillas/plantilla1.png" height="142" width="142">

  </div>
    <div class='col-md-2' >
      <input class="form-control" name="id" type="hidden"  value=<?php echo $obj->codusuario;?> >

      <input type="hidden"  name="procesar" value="2" />
        <input  type="image"  src="../imagenes/plantillas/plantilla2.png" height="142" width="142">
