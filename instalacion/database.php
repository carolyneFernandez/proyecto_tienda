...
$connection->query("INSERT INTO `producto` (`codproducto`, `coddistribuidor`, `nombre`, `descripcion`, `stock`, `foto`, `categoria`, `precio`, `sexo`) VALUES
    ...
    (107, 501, 'SUDADERA MATTE ', 'Te gusta sobresalir un poco. Lo entendemos. Y estï¿½bamos pensando en ti cuando diseï¿½amos esta sudadera con cuello redondo. Es elegante, deportiva y lo suficientemente llamativa, ya que estï¿½ engalanada con la marca PUMA y exclusivos detalles de colores combinados.', 24, 'sudadera1.jpg', 'sudaderas', 65.00, 'mujer'),
    (108, 501, 'CHAQUETA CON CAPUCHA', 'El tema con las chaquetas con capucha es que... nunca son suficientes. Y esta, con sus excelentes colores, sus acabados ideales y una cómoda confección en felpa francesa, es una incorporación obvia a tu conjunto de sudaderas.\r\n\r\nCaracterísticas:algodón, 35% poliéster, Felpa francesa Propiedades que absorben la humedad para que estés seco y cómodo', 15, 'chaqueta5.jpg', 'chaquetas', 26.30, 'mujer'),
    (109, 501, 'SUDADERA BLURRED BOMBER', 'PUMA ha sido el mas o, bueno, desde siempre. Y hacemos uso de nuestra historia buscando en nuestros archivos algunos estilos clï¿½sicos renovados, inspirados en el deporte pero diseï¿½ados para la calle. Esta sudadera con cierre completo hace alarde de un estampado en toda la prenda, destacado por mangas de color en contraste.\r\n\r\nCaracterï¿½sticas\r\n\r\n70% algodï¿½n, 30% poliï¿½ster\r\nCierre completo\r\nImitaciï¿½n de cierre impermeable, invertido\r\nDos bolsillos laterales reforzados', 14, 'sudadera4.jpg', 'sudaderas', 65.00, 'mujer'),
    ...
    (113, 502, 'Pantalon capri Branded', 'Fï¿½ciles de combinar, estos pantalones capri para mujer presentan un tiro mï¿½s bajo que le da un toque moderno. Estï¿½n confeccionados con un tejido que aleja el sudor de la piel para mantenerte seca y cï¿½moda.', 15, 'pantalon2.jpg', 'pantalones', 20.50, 'mujer'),
